  ...
  return (
    <footer className="relative top-10 md:top-40 lg:top-30 max-w-7xl mx-auto pb-0 px-4" id="contact" style={{zIndex:"1"}}>
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="pt-5 md:p-0 mt-0" style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
      ...
      <div className="flex mt-16 flex-row justify-between items-center">
        ...
        <div className="flex items-center md:gap-3 gap-6">
          {socialMedia.map((info) => (
            <div
              key={info.id}
              className="w-10 h-10 cursor-pointer flex justify-center items-center border border-white/[0.2] bg-black-200 rounded-lg"
            >
