...
import {
    ...
    useTransform,
    MotionValue,
} from "framer-motion"; // ✅ FIXED: Correct import source
...
const FloatingDockMobile = ({
    ...
    return (
        <div className={cn("fixed bottom-4 right-4 block md:hidden z-50", className)}>
            <AnimatePresence>
                {open && (
                    <motion.div
                        layoutId="nav"
            ...
            >
                <IconLayoutNavbarCollapse className="h-5 w-5 text-white-500 dark:text-neutral-400" />
            </button>
        </div>
    );
};
